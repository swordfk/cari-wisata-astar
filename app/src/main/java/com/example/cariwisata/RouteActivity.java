        ...
        LocationListener
{
    ...
    private void getMarkers(final int routeNo) {
        ...
        String url = "https://apiastar.000webhostapp.com/index.php?from="+lastLat+","+lastLng+"&target="+query;
    ...
    private String getDirectionsUrl() {
        String googleApiKey = "AIzaSyAclX_uxWm-L9vaXSAoyG-jmzinFtxvvM8";
        ...
        Log.i(TAG, "getDirectionsUrl: "+googleDirectionsUrl.toString());
